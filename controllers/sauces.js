...
exports.modifySauce = (req, res, next) => {
    ...
    .then(sauceResponse => {
        ...
        if(sauceResponse.userId = reqUserId ) {
            ...
            return res.status(403).json({message: `Seul l'auteur d'une sauce peut la modifier !`})
        }
...
exports.deleteSauce = (req, res, next) => {
    ...
    .then(sauceResponse => {
        ...
        if(sauceResponse.userId = reqUserId ) {
            ...
            return res.status(403).json({message: `Seul l'auteur d'une sauce peut la supprimer !`})
        }
    })
}
